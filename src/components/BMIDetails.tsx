    ...
    <div className="glass-card p-6 md:p-8 animate-slide-up" style={{ animationDelay: "0.2s" }}>
      ...
      <div className="bg-muted/50 rounded-xl p-5 mb-6">
        ...
        <div className="flex items-center justify-center gap-2 text-lg font-mono">
          <span className="text-primary font-bold">IMC</span>
          <span>=</span>
          <div className="text-center">
            <div className="border-b border-foreground/30 pb-1 px-3">
          ...
          <span>=</span>
          <span className="text-2xl font-bold gradient-text">{bmi.toFixed(2)}</span>
        </div>
      </div>
